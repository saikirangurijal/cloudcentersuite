...
#
# Push configuraiton to F5 BIG-IP using AS3
#
...
url_dict = {'deploy':'''/mgmt/shared/appsvcs/declare/''',
           }

session = requests.Session()

def argparser():
    parse = argparse.ArgumentParser(description='Push AS3 configuration to F5 BIG-IP using REST.')
...
def main(args):
    ...
    template_file = str(json_var["template"])
