...
# Logging messages
def print_log(msg):
    print('CloudCenter_EXTERNAL_SERVICE_LOG_MSG_START')
    print(msg)
    print('CloudCenter_EXTERNAL_SERVICE_LOG_MSG_END')


# Print result
def print_result(msg):
    print('CloudCenter_EXTERNAL_SERVICE_RESULT_START')
    print(msg)
    print('CloudCenter_EXTERNAL_SERVICE_RESULT_END')
...
error_message()    #!/usr/bin/env python
