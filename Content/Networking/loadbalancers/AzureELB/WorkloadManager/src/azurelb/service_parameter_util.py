    ...
    try:
        ...
        if isinstance(_load_balancer_rules, list):
            ...
            for i in range(0, _lb_rules_count):
                _lb_rules.append([os.environ['loadBalancerRules_loadBalancerProtocol_' + str(i)], os.environ['loadBalancerRules_frontEndPort_' + str(i)], os.environ['loadBalancerRules_backEndPort_' + str(i)], os.environ['loadBalancerRules_idleTimeout_' + str(i)]])
    except Exception as err:
        print_log(err)
