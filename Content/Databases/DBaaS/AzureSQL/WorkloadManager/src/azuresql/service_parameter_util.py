...
account_params = {
    'Cloud_Setting_SubscriptionId': "subscriptionId",
...
def create_params_json():
    ...
    try:
        ...
        try:
            params['publicIP'] = os.environ['CliqrTier_' + dependents + "_PUBLIC_IP"]
        except Exception as e:
            print_log("public ip not found in dependant tier. Assigning public IP")
            params['publicIP'] = "0.0.0.0"
